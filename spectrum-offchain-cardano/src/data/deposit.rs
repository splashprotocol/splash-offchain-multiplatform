...
use crate::deployment::ProtocolValidator::{BalanceFnPoolDeposit, ConstFnFeeSwitchPoolDeposit, ConstFnPoolDeposit, StableFnPoolT2TDeposit};
        ...
        + Has<DepositOrderBounds>,
{
    fn try_from_ledger(repr: &BabbageTransactionOutput, ctx: &Ctx) -> Option<Self> {
        ...
        if (is_const_fee_switch_pool_deposit || is_balance_fn_pool_deposit || is_const_fn_pool_deposit || is_stable_fn_pool_deposit) {
