...
pub struct DeployedValidators {
    ...
    pub stable_fn_pool_t2t_exact: DeployedValidatorRef,
...
impl From<&DeployedValidators> for ProtocolScriptHashes {
    fn from(deployment: &DeployedValidators) -> Self {
        Self {
            ...
            stable_fn_pool_t2t_exact: From::from(&deployment.stable_fn_pool_t2t_exact),
...
pub struct ProtocolScriptHashes {
    ...
    pub stable_fn_pool_t2t_exact: DeployedScriptInfo<{ ProtocolValidator::StableFnPoolT2TExact as u8 }>,
...
pub struct ProtocolDeployment {
    ...
    pub stable_fn_pool_t2t_exact: DeployedValidator<{ ProtocolValidator::StableFnPoolT2TExact as u8 }>,
...
impl ProtocolDeployment {
    pub async fn unsafe_pull<Net: CardanoNetwork>(validators: DeployedValidators, explorer: &Net) -> Self {
        Self {
            ...
            stable_fn_pool_t2t_exact: DeployedValidator::unsafe_pull(validators.stable_fn_pool_t2t_exact, explorer).await,
