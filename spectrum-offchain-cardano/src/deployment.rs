...
pub enum ProtocolValidator {
    ...
    RoyaltyPoolV1 = 26,
    RoyaltyPoolV1Deposit = 27,
    RoyaltyPoolV1Redeem = 28,
    RoyaltyPoolV1RoyaltyWithdrawRequest = 29,
    RoyaltyPoolV2 = 30,
    RoyaltyPoolV2Deposit = 31,
    RoyaltyPoolV2Redeem = 32,
    RoyaltyPoolV2RoyaltyWithdrawRequest = 33,
    RoyaltyPoolRoyaltyWithdraw = 34,
    RoyaltyPoolRoyaltyWithdrawV2 = 35,
    RoyaltyPoolDAOV1Request = 36,
    RoyaltyPoolDAOV1 = 37,
    RoyaltyPoolV2DAO = 38,
    RoyaltyPoolDAOV2 = 39,
}
