...
pub const POOL_VALIDITY_POLICY_ID_HEX: &str = "13aa2accf2e1561723aa26871e071fdf32c867cff7e7d50ad470d62f4d494e53574150";
...
lazy_static! {
    ...
    pub static ref POOL_VALIDITY_POLICY_ID: PolicyId = PolicyId::from_hex(POOL_VALIDITY_POLICY_ID_HEX).unwrap();
}
