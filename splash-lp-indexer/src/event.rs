...
impl<Cx> TryFromLedger<TxViewPartiallyResolved, Cx> for LpEvent {
    fn try_from_ledger(repr: &TxViewPartiallyResolved, ctx: &Cx) -> Option<Self> {
        <Either<Deposit, Redeem>>::try_from_ledger(repr, ctx)
            .map(|deposit_or_redeem| deposit_or_redeem.either(LpEvent::Deposit, LpEvent::Redeem))
...
impl<Cx> TryFromLedger<TxViewPartiallyResolved, Cx> for Either<Deposit, Redeem> {
    fn try_from_ledger(repr: &TxViewPartiallyResolved, ctx: &Cx) -> Option<Self> {
